...
#' @param split partitions the dataset into two groups. If <= 1 then \code{split} is a percentage value such that \code{T*split} observations are in the first partition. If \code{split} >= 1 it is interpreted as the index of the partitioning observation, i.e. the number of observations in the first group.
