#' F-test on Multiple Linear Combinations of Parameters in a Linear Model
#'
...
#' }
#' If \code{plot.what = "ellipse"} is specified, futher arguments can be passed to \code{plot()}:
#' \tabular{ll}{
...
#' }
#'
#' @return A list objecct including:
#' \tabular{ll}{
