...
#' @param data name of dataframe of variables in \code{formula}.
...
#' \code{call} \tab the function call by which the regression was calcluated (including \code{modform}).\cr
#' }
#' @export
#'
