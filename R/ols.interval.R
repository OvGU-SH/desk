...
#' @param data name of dataframe to be specified if mod is a formula.
...
#' \tabular{ll}{
#' \code{results} \tab interval borders (lower and upper) and center of interval.\cr
#' \code{std.err} \tab estimated standard deviations.\cr
#' \code{t.value} \tab critical t-value.\cr
#' }
#' interval borders (lower and upper) and center of interval (if dir = "both"), the standard error and the t.value.
#'
#' @export
#'
#' @examples
