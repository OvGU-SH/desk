...
#'
#' @description This function implements an S3 method for printing regression- and test-results generated by functions of the desk package. Used for internal purposes.
#'
#' @param x object of class desk to be printed to the console.
#' @param details logical value indicating whether details of object \code{x} should be printed.
#' @param digits number of digits to round to (only output).
#' @param ... any argument that \code{print()} accepts.
#'
#' @return None.
#' @export
#'
