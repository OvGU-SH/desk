...
#'
#' @description This is a data set on the unemployment rates and the sick leave in Germany in the years 1992 to 2014.
#'
...
#'
#' @details
#' In Auer et al. (2023, Chap. 18) these data are used to illustrate the consequences of autocorrelated error terms.
#'
#' @source
