...
#' @param which string value specifying the type of criterion: \code{"aic"} (Akaike Information Criterion), \code{"sic"} (Schwarz Information Criterion), or \code{"pc"}, (Prognostic Criterion), optional, if ommitted then all criteria are returned (\code{"all"}).
#' @param scaled logical value which indicates whether criteria should be scaled by the number of observations T.
#'
#' @return Dataframe of AIC, SIC, and PC values.
#'
#' @export
#'
