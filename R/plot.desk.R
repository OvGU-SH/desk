...
#'
#' @description This function implements an S3 method for plotting regression- and test-results generated by functions of the desk package. Used for internal purposes.
#'
#' @param x object of class desk to be plotted.
#' @param ... any argument that \code{plot()} accepts.
#'
#' @export
#'
#' @importFrom grDevices rgb
#' @importFrom graphics abline arrows axis curve legend lines matlines matplot points polygon segments text
#' @importFrom stats cor fitted lm.fit qf qt vcov
#'
#' @examples
