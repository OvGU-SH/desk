...
#' @param rho true rho value of the AR(1) process to be simulated.
#' @param u0 start value of the process in t = 0.
#' @param var.e variance of the random error. If zero, no random error is added.
#' @param details logical value indicating whether details should be printed.
#' @param seed optionally set a custom random seed for reproducing results.
#'
...
#'
#' @note Objects generated by \code{ar1sim()} can be plotted using the regular \code{plot()} command.
#'
...
#' par(mfrow = c(1,1))
#'
#' @keywords AR(1) process, autocorrelated errors, simulation
#'
